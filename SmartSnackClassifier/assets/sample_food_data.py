...
This file contains sample food data for classification, nutrition information,
and recommendation features. This data is used as a placeholder until a real
AI model and database can be implemented.
"""
